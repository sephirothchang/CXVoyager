...
from cxvoyager.library.common.system_constants import DEFAULT_CONFIG_FILE, PROJECT_ROOT
...
from cxvoyager.process.workflow.query_cluster import query_cluster_by_name
from cxvoyager.process.workflow.query_vnet import query_vnet_by_name
...
def handle_deploy_obs(ctx_dict):
    ...
    search_roots = [
        ...
        PROJECT_ROOT / "cxvoyager" / "resources",
